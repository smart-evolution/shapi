...
class SoundChart extends React.PureComponent {
  componentWillReceiveProps(props) {
    ...
    const maxSound = _.isUndefined(maxObj) ? DEFAULT_MAX_SOUND : Number(maxObj.value) + SOUND_MARGIN;

    const minObj = _.minBy(sounds, 'value');
    const minSound = _.isUndefined(minObj) ? DEFAULT_MIN_SOUND : Number(minObj.value) - SOUND_MARGIN;
    ...
    svg.selectAll('.sound-chart__dot')
      .data(sounds)
      .enter().append('circle')
